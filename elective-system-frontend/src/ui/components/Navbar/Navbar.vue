	...
	<nav class="navbar navbar-expand-lg bg-body-tertiary">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse flex-wrap" id="navbarNav">
				<ul class="navbar-nav">
					<li class="nav-item">
						<router-link to="/" class="navbar-brand nav-link" href="#">Inicio</router-link>
					</li>
					<li class="nav-item">
						<router-link to="/about" class="nav-link active nav-item-who" aria-current="page" href="#">
							¿Quiénes somos?</router-link>
					</li>
					<li class="nav-item">
						<router-link to="/user-manual" class="nav-link nav-item-how" aria-current="page" href="#">
